...
type FAQProps = {
    ...
    description?: string;
    /** List of Q&As; if omitted, uses a sane default set */
    items?: FAQItem[];
...
/** Default FAQ content aligned to our LP DoD */
const DEFAULT_ITEMS: FAQItem[] = [
    ...
    { q: 'Quanto vai custar após o Beta?', a: 'Starter R$ 19,90/mês e Business R$ 59,90/mês. Testers têm -30% por 12 meses.' },
];

/** 
 * Accessible FAQ block using <details>/<summary>
 *   - Semantic heading and aria-labelledby for screen readers
 *   - No analytics by default; parent can hook onToogle for GA4.
 *   - Visual style that matches our current LP cards.
 */
